...
class EntityUtilTest {
  ...
  void testMerge_entities_same_types_and_id() {
    Collection<SdkEntity> base =
        Arrays.asList(
            SdkEntity.builder("a")
                .setSchemaUrl("one")
                .setIdentity(Attributes.builder().put("a.id", "a").build())
                .setDescription(Attributes.builder().put("a.desc1", "a").build())
                .build());
    Collection<SdkEntity> added =
        Arrays.asList(
            SdkEntity.builder("a")
                .setSchemaUrl("one")
                .setIdentity(Attributes.builder().put("a.id", "a").build())
                ...
                .build());
    Collection<SdkEntity> merged = EntityUtil.mergeEntities(base, added);
    ...
    assertThat(merged)
        .anySatisfy(
            entity -> {
              ...
              assertThat(entity.getIdentity()).containsEntry("a.id", "a");
  ...
  void testMerge_entities_same_types_different_id() {
    ...
    Collection<SdkEntity> added =
        Arrays.asList(
            SdkEntity.builder("a")
                .setSchemaUrl("one")
                .setIdentity(Attributes.builder().put("a.id", "b").build())
                .setDescription(Attributes.builder().put("a.desc2", "b").build())
                .build());
    Collection<SdkEntity> merged = EntityUtil.mergeEntities(base, added);
    assertThat(merged).hasSize(1);
  ...
  void testMerge_entities_separate_types_and_schema() {
    ...
    Collection<SdkEntity> added =
        Arrays.asList(
            SdkEntity.builder("b")
                .setSchemaUrl("two")
                .setIdentity(Attributes.builder().put("b.id", "b").build())
                .build());
    Collection<SdkEntity> merged = EntityUtil.mergeEntities(base, added);
    ...
    String result =
        EntityUtil.mergeResourceSchemaUrl(
            Arrays.asList(
                SdkEntity.builder("t")
                    .setSchemaUrl("one")
                    .setIdentity(Attributes.builder().put("id", 1).build())
                    .build()),
            "one",
            null);
    assertThat(result).isEqualTo("one");
        ...
        EntityUtil.mergeResourceSchemaUrl(
            Arrays.asList(
                SdkEntity.builder("t")
                    ...
                    .setIdentity(Attributes.builder().put("id", 1).build())
                    .build(),
                SdkEntity.builder("t2")
                    .setSchemaUrl("two")
                    .setIdentity(Attributes.builder().put("id2", 1).build())
                    .build()),
            "one",
            "one");
  ...
  void testRawAttributeMerge_entity_with_conflict() {
    ...
    RawAttributeMergeResult result =
        EntityUtil.mergeRawAttributes(
            ...
            Arrays.asList(
                SdkEntity.builder("c")
                    .setIdentity(Attributes.builder().put("c", 1).build())
                    .build()));
  ...
  @Test
  void testAddSdkEntity_reflection() {
    Resource result =
        EntityUtil.addEntity(
                Resource.builder(),
                SdkEntity.builder("a")
                    .setIdentity(Attributes.builder().put("a", 1).build())
                    .build())
            .build();
  ...
  @Test
  void testAddAllSdkEntity_reflection() {
    Resource result =
        EntityUtil.addAllEntity(
                ...
                Arrays.asList(
                    SdkEntity.builder("a")
                        ...
                        .build(),
                    SdkEntity.builder("b")
                        .setIdentity(Attributes.builder().put("b", 1).build())
                        .build()))
            .build();
    assertThat(EntityUtil.getEntities(result))
        .satisfiesExactlyInAnyOrder(
